...
import net.imglib2.algorithm.convolution.kernel.KernelConvolverFactories;
...
public class ConvolverBenchmark
{
	...
	public void asymmetricKernelConvolver() {
		ConvolverFactory< DoubleType, DoubleType > assymetricConvolver = KernelConvolverFactories.get( Kernel1D.symmetric( halfKernel ), new DoubleType(), new DoubleType() );
